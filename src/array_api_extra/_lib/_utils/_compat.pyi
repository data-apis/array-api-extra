...
def is_array_api_strict_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_cupy_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_dask_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_jax_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_numpy_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_pydata_sparse_namespace(xp: ArrayNamespace, /) -> bool: ...
def is_torch_namespace(xp: ArrayNamespace, /) -> bool: ...
